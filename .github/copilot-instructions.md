...
- **Shared data**: `SharedModelContainer` provides a SwiftData `ModelContainer` backed by an App Group (`group.de.davidochmann.bucketlist`) so the main app and share extension access the same database.
